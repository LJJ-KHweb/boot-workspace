...
public class ReviewDto {
	...
	private Long ucSeq;
	// @NotNull => NULL 못들어온다 / "" 들어올 수 있다 / " " 들어올수있다 => 장점 : 모든 타입에 사용이 가능하다
	// @NotEmpty => NULL 못들어온다 / ""들어올 수 있다 / " " 들어올수없다 => String, Collection, Map
	// , 배열
	// @NotBlank => NULL 못들어온다 / ""들어올 수 없다 / " " 들어올수없다 => String전용
	@NotBlank(message = "내용은 필수 작성 요소입니다.")
	private String content;
	@NotNull(message = "별점은 필수 작성 요소입니다.")
	@Max(value = 5, message = "별점은 5점이하여야 합니다")
	@Min(value = 1, message = "별점은 1점이상이여야 합니다.")
	...
	public String toString() {
		return "ReviewDto [content=" + content + ", createDate=" + createDate + ", rating=" + rating + ", ucSeq="
				+ ucSeq + "]";
	}
