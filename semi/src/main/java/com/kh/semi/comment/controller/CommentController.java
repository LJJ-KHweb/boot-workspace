...
public class CommentController {
	...
	@GetMapping
	public ResponseEntity<ApiResponse<List<CommentDto>>> findAll(@RequestParam(value = "boardNo") Long boardNo) {
		List<CommentDto> comments = commentService.findAll(boardNo);
		// ApiResponse<List<CommentDto>> ar = new ApiResponse(200,"그렇지만",comments);
